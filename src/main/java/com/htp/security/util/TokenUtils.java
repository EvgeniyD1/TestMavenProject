...
public class TokenUtils {
    ...
    private Boolean isCreatedBeforeLastPasswordReset(Date created, Date lastPasswordRequest) {
        return (lastPasswordRequest != null && created.before(lastPasswordRequest));
    }
